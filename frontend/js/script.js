jQuery(document).ready(function ($) {
	...
	(function ($) {
		...
		function listFilter(searchDir, list) {
			var form = $("<form>").attr({ "class": "filterform", "action": "#" }),
				input = $("<input>").attr({ "class": "filterinput", "type": "text", "placeholder": "Search psycholigist..." });
	...
	$('button.rsignup').on("click", function () {
		$('.login-reg-bg-p').addClass('show');
...
logout.forEach(log => log.addEventListener('click', () => {
